...
def Coupling(input_shape):
    ...
    t_layer = input
    for _ in range(N_ST_LAYER):
        t_layer = layers.Dense(
            HIDDEN_DIM, activation=ACT, kernel_regularizer=regularizers.l2(L2)
        )(t_layer)
    t_layer = layers.Dense(
        input_shape, activation="linear", kernel_regularizer=regularizers.l2(L2)
    )(t_layer)
    ...
    s_layer = layers.Dense(
        input_shape, activation="tanh", kernel_regularizer=regularizers.l2(L2)
    )(s_layer)
